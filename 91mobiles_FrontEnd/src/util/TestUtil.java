...
public static void captureScreenshot(String path) throws IOException{
		...
		Calendar cal = new GregorianCalendar();
	     ...
	     //String ImageDest = "C:\\Program Files\\Apache Software Foundation\\Tomcat 9.0\\webapps\\ROOT\\screenshots\\";
		 // String ImageDest = "//opt//tomcat//webapps//ROOT//screenshots//";
		 String ImageDest = "//var//www//html//screenshots//";
		 
		  //String ImageDest = " //home//ahtisham//Automation//91mobiles_Web//screenshots//";
		 
		  
		  imageName = ImageDest+DriverApp.currentTest+DriverApp.currentTSID+year+"_"+date+"_"+(month+1)+"_"+day+"_"+min+"_" +sec;
		   System.out.println("Image Name:-"+imageName);
		   System.out.println("SS Folder:-"+CONFIG.getProperty("screenshotPath"));
