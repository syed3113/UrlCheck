...
public class monitoringMail
{
	...
	public static void sendMail(String mailServer, String from,String[] to, String subject, String messageBody) throws MessagingException, AddressException
	{
		...
		props.put("mail.smtp.user", TestConfig.from);
		props.put("mail.smtp.password", TestConfig.password);
