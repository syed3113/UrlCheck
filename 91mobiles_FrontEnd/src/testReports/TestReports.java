...
public class TestReports{
	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
	    ...
	    out.write("<td width=150 align=left><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75> <img src=\"C:\\Users\\91mobiles\\Desktop\\91mobiles_logo.png\"  align=right></img></td>\n"); 
	     ...
	     out.write("<tr>\n");
	           ...
	           out.write("<h4> <FONT COLOR=black FACE=Arial SIZE=4.5> <u>Test Summary</u></h4>\n");
	           out.write("<td width=150 align=left bgcolor=red><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Execution Date</b></td>\n");
	           out.write("<td width=150 align=left><FONT COLOR=black FACE=Arial SIZE=2.75><b>"+RUN_DATE+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	           
	           out.write("<td width=150 align=left bgcolor=red><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Start Time</b></td>\n");

	           out.write("<td width=150 align=left><FONT COLOR=black FACE=Arial SIZE=2.75><b>"+testStartTime+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	    // out.newLine();   
	           out.write("<td width=150 align= left  bgcolor=red><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>End Time</b></td>\n");
	...
	public static String addTestCase(String testCaseName,String testCaseStartTime,String testCaseEndTime,String status,int tcid){
		newTest=true;
		FileWriter fstream=null;
		BufferedWriter out=null;
		...
		try {
		   ...
		   if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")){
			...
			out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> 91mobiles Automation Detailed Report  :</h4>");
		 	 out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
		 	 out.write("<tr> ");
		 		 ...
		 		 for(int i=0;i<description.size();i++){
		 			...
		 			if(teststatus.get(i).startsWith("Pass")){
		 			     out.write("<td width=20% align= center  bgcolor=#BCE954><FONT COLOR=black FACE=Arial SIZE=2><b>"+teststatus.get(i)+"</b></td>\n");
		 			  	 ...
		 			  	 out.write("<td width=20% align= center  bgcolor=Red><FONT COLOR=black FACE= Arial  SIZE=2><b><a href="+screenShotPath.get(i)+" target=_blank>"+teststatus.get(i)+"</a></b></td>\n");
		 			}
		 			...
		 			// out.write("<td align=center width=20% bgcolor=Red><FONT COLOR=black FACE=Arial SIZE=1><b><a href="+screenShotPath.get(i)+" target=_blank>Screen Shot</a></b></td>");
		 			 System.out.println("Screenshot path:"+screenShotPath.get(i));}
		 			 else
		 				out.write("<td align=center width=20% bgcolor=Red><FONT COLOR=black FACE=Arial SIZE=1><b>&nbsp;</b></td>");	 
		 			 out.write("</tr>");
		 			}
		 	 }
		 	 }
			...
			// out.newLine();
		     ...
		     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
		    	...
		    	// out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverScript.year+"_"+DriverScript.date+"_"+(DriverScript.month+1)+"_"+DriverScript.day+"_"+DriverScript.min+"_" +DriverScript.sec+".html>"+testCaseName+"</a></b></td>\n");
		    	 out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=http://"+TestUtil.Handeler()+"//htmlpages"+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html>"+testCaseName+"</a></b></td>\n");
		     ...
		     out.write("<td width=10% align= center  bgcolor=#BCE954><FONT COLOR=black FACE=Arial SIZE=2><b>"+status+"</b></td>\n");
		    	 ...
		    	 out.write("<td width=10% align= center  bgcolor=Red><FONT COLOR=black FACE= Arial  SIZE=2><b>"+status+"</a></b></td>\n");
		...
		newTest=false;
		return currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html";
	}
