...
public class SendMail {
	//public static void sendMail(String mailServer, String from,String username, String password,String port, String[] to, String subject, String messageBody, String attachmentPath, String attachmentName) throws MessagingException, AddressException
		public static void send(String mailServer, String from,String[] to, String subject, String messageBody,String attachmentPath,String attachmentName) throws MessagingException, AddressException
		{
			...
			props.put("mail.smtp.user", InvokeMail.from);
			props.put("mail.smtp.password", InvokeMail.password);
				    ...
				    new javax.mail.Authenticator(){
				        protected PasswordAuthentication getPasswordAuthentication() {
				            return new PasswordAuthentication(
				                "syed.gaadi@gmail.com", "nbawpdsgazfbmilj");// Specify the Username and the PassWord 
				        }
				});
